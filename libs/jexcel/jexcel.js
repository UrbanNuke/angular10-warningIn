    ...
    var jexcel = (function(el, options) {
        ...
        obj.setData = function(data) {
            ...
            if (obj.options.lazyLoading == true) {
                ...
                var startNumber = 0
                var finalNumber = obj.options.data.length < 150 ? obj.options.data.length : 150;
...
console.log(ret);
                ...
                if (item > 0) {
                    for (var j = 0; j < 30; j++) {
                        ...
                        if (item > -1) {
                            ...
                            if (obj.tbody.children.length > 150) {
        ...
        obj.loadValidation = function() {
            if (obj.selectedCell) {
                var currentPage = parseInt(obj.tbody.firstChild.getAttribute('data-y')) / 150;
                var selectedPage = parseInt(obj.selectedCell[3] / 150);
                var totalPages = parseInt(obj.rows.length / 150);
        ...
        obj.setHistory = function(changes) {
            if (obj.ignoreHistory != true) {
                ...
                obj.dispatch('onhistorychange', index, obj.history);
			}
        }
